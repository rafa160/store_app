class Address {
  ...
  @override
  String toString() {
    return 'Address{altitude: $altitude, cep: $cep, latitude: $latitude, longitude: $longitude, logradouro: $logradouro, bairro: $bairro, complemento: $complemento, cidade: $cidade, estado: $estado}';
  }
}
